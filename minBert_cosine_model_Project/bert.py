...
class BertLayer(nn.Module):
  ...
  def forward(self, hidden_states, attention_mask):
    ...
    intermediate_output = self.interm_af(self.interm_dense(hidden_states))

    #4. a add-norm that takes the input and output of the feed forward layer
    output_states = self.add_norm(hidden_states, intermediate_output, self.out_dense, self.out_dropout, self.out_layer_norm)
